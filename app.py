...
def upload_file_to_gcp_bucket(bucket_name, source_file_path, destination_blob_name, credentials_path, make_public=True):
    ...
    if make_public:
        blob.make_public()
        print(f"File {destination_blob_name} is now public.")
